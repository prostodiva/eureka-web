    ...
    >
      <div className="relative z-10 flex flex-col items-center w-full px-4 pt-24 sm:pt-28 md:pt-32 pb-16 sm:pb-20 md:pb-24">
        ...
        <p className="text-white font-inter text-center text-sm sm:text-base md:text-lg leading-relaxed mt-2 sm:mt-3 max-w-4xl">
          ...
          Features interactive puzzle gameplay with custom input handling, game
          state management, and dynamic UI updates. This project highlights
          experience in Unity development, object-oriented design, performance
          optimization, and integration between a game client and a web
          platform.
        </p>
