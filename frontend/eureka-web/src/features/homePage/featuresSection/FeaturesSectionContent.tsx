...
function FeatureSectionContent({
  ...
  return (
      <div className="flex flex-col items-start px-[4vw] pt-[3vh] z-10">
          <h2 className={`font-kingfink ${textColor} text-[clamp(2rem,4vw,7rem)] leading-none mb-[2vh]`}>
              {title}
          </h2>

          {description && (
              <p className={`font-inter ${textColor} text-[clamp(0.75rem,1vw,1.5rem)] max-w-[30vw] leading-relaxed mb-[2vh]`}>
                  {description}
              </p>
          )}
