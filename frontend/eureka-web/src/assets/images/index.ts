import { makeResponsiveImage } from '@/utils/makeResponsiveImage';
...
import comp19_400avif from '@/assets/optimized/comp_19-400.avif';
import comp19_800avif from '@/assets/optimized/comp_19-800.avif';
import comp19_1200avif from '@/assets/optimized/comp_19-1200.avif';
import comp19_1600avif from '@/assets/optimized/comp_19-1600.avif';
import comp19_2400avif from '@/assets/optimized/comp_19-2400.avif';
import comp19_400webp from '@/assets/optimized/comp_19-400.webp';
import comp19_800webp from '@/assets/optimized/comp_19-800.webp';
import comp19_1200webp from '@/assets/optimized/comp_19-1200.webp';
import comp19_1600webp from '@/assets/optimized/comp_19-1600.webp';
import comp19_2400webp from '@/assets/optimized/comp_19-2400.webp';

export const homeHeroBg = makeResponsiveImage({
...
export const comp19 = makeResponsiveImage({
  fallbackSrc: comp19_800webp,
  avif400: comp19_400avif,
  avif800: comp19_800avif,
  avif1200: comp19_1200avif,
  avif1600: comp19_1600avif,
  avif2400: comp19_2400avif,
  webp400: comp19_400webp,
  webp800: comp19_800webp,
  webp1200: comp19_1200webp,
  webp1600: comp19_1600webp,
  webp2400: comp19_2400webp,
});
...
export const featuresHome = makeResponsiveImage({
...
export const arrowLeft = makeResponsiveImage({
...
export const arrowRight = makeResponsiveImage({
...
export const alekseiImg = makeResponsiveImage({
...
export const faq = makeResponsiveImage({
...
export const gameplayFeatures = makeResponsiveImage({
...
export const aboutUsHome = makeResponsiveImage({
...
export const footerBg = makeResponsiveImage({
...
export const contactConnect = makeResponsiveImage({
...
export const contactHero = makeResponsiveImage({
...
export const box = makeResponsiveImage({
  ...
  avif400: box400avif,
  avif800: box800avif,
  avif1200: box1200avif,
  avif1600: box1600avif,
  avif2400: box2400avif,
  webp400: box400webp,
  webp800: box800webp,
...
export const puzzle1 = makeResponsiveImage({
  ...
  avif400: puzzle1_400avif,
  avif800: puzzle1_800avif,
  avif1200: puzzle1_1200avif,
  avif1600: puzzle1_1600avif,
  avif2400: puzzle1_2400avif,
  webp400: puzzle1_400webp,
  webp800: puzzle1_800webp,
  webp1200: puzzle1_1200webp,
  webp1600: puzzle1_1600webp,
  webp2400: puzzle1_2400webp,
});

export const puzzle2 = makeResponsiveImage({
  fallbackSrc: puzzle2_800webp,
  avif400: puzzle2_400avif,
  avif800: puzzle2_800avif,
  avif1200: puzzle2_1200avif,
  avif1600: puzzle2_1600avif,
  avif2400: puzzle2_2400avif,
  webp400: puzzle2_400webp,
  webp800: puzzle2_800webp,
  webp1200: puzzle2_1200webp,
  webp1600: puzzle2_1600webp,
  webp2400: puzzle2_2400webp,
});

export const puzzle3 = makeResponsiveImage({
  fallbackSrc: puzzle3_800webp,
  avif400: puzzle3_400avif,
  avif800: puzzle3_800avif,
  avif1200: puzzle3_1200avif,
  avif1600: puzzle3_1600avif,
  avif2400: puzzle3_2400avif,
  webp400: puzzle3_400webp,
  webp800: puzzle3_800webp,
  webp1200: puzzle3_1200webp,
  webp1600: puzzle3_1600webp,
  webp2400: puzzle3_2400webp,
});

export const puzzle4 = makeResponsiveImage({
  fallbackSrc: puzzle4_800webp,
  avif400: puzzle4_400avif,
  avif800: puzzle4_800avif,
  avif1200: puzzle4_1200avif,
  avif1600: puzzle4_1600avif,
  avif2400: puzzle4_2400avif,
  webp400: puzzle4_400webp,
  webp800: puzzle4_800webp,
  webp1200: puzzle4_1200webp,
  webp1600: puzzle4_1600webp,
  webp2400: puzzle4_2400webp,
});
...
export const val = makeResponsiveImage({
  ...
  avif400: val400avif,
  avif800: val800avif,
  avif1200: val1200avif,
  avif1600: val1600avif,
  avif2400: val2400avif,
  webp400: val400webp,
  webp800: val800webp,
  webp1200: val1200webp,
  webp1600: val1600webp,
  webp2400: val2400webp,
});

import heroMobile400avif from '@/assets/optimized/heroMobile-400.avif';
import heroMobile800avif from '@/assets/optimized/heroMobile-800.avif';
import heroMobile1200avif from '@/assets/optimized/heroMobile-1200.avif';
import heroMobile1600avif from '@/assets/optimized/heroMobile-1600.avif';
import heroMobile2400avif from '@/assets/optimized/heroMobile-2400.avif';
import heroMobile400webp from '@/assets/optimized/heroMobile-400.webp';
import heroMobile800webp from '@/assets/optimized/heroMobile-800.webp';
import heroMobile1200webp from '@/assets/optimized/heroMobile-1200.webp';
import heroMobile1600webp from '@/assets/optimized/heroMobile-1600.webp';
import heroMobile2400webp from '@/assets/optimized/heroMobile-2400.webp';

export const heroMobile = makeResponsiveImage({
  fallbackSrc: heroMobile800webp,
  avif400: heroMobile400avif,
  avif800: heroMobile800avif,
  avif1200: heroMobile1200avif,
  avif1600: heroMobile1600avif,
  avif2400: heroMobile2400avif,
  webp400: heroMobile400webp,
  webp800: heroMobile800webp,
  webp1200: heroMobile1200webp,
