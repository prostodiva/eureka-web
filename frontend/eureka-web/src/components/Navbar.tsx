...
function Navbar({
                    ...
                    linkClassName = 'my-2 md:mx-8 text-gray-400 flex items-center gap-2',
    ...
    const defaultLinks: NavLink[] = [
      ...
      { label: 'Why Us', path: '/why', icon: <RiPuzzle2Fill className="-scale-y-100 -scale-x-100"/> },
      { label: 'About Us', path: '/about', icon: <FaPuzzlePiece /> },
      { label: 'Contact', path: '/contact', icon: <RiPuzzle2Fill className="-scale-x-100" /> },
    ];
